                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            <h2 class="text-right mt-2 f-w-300">Next</h2>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <span class="text-right d-block h5">Marked</span>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <span class="text-right d-block h5">Finished</span>
                                            ...
                                            <div class="card-block pb-0">
                                                ...
                                                @if ($user->type === 'patient')
                                                    <a href="{{ route('appointments.index') }}" class="btn btn-outline-primary" style="width: 100%; margin-bottom: 20px;">
                                                        <i class="feather icon-plus-circle"></i>Schedule Consultation
                                                    </a>
                                                @endif
                                            </div>
                                        </div>
