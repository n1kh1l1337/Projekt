                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Configuration</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                    ...
                                    <div class="card User-Activity">
                                        ...
                                        <div class="card-block pb-0">
                                            <form class="link-form" action='{{ route('users.update', $user->id) }}' method='POST' enctype="multipart/form-data">
                                                ...
                                                @if ($user->type === 'patient')
                                                    ...
                                                    <div class="form-group mt-2">
                                                        ...
                                                        <select class="form-control" id="blood-type" name="blood">
                                                            <option value="{{ $user->patient->blood_type ?? '' }}">{{ $user->patient->blood_type ?? 'Selection' }}</option>
                                                ...
                                                @endif
                                                @if ($user->type === 'doctor')
                                                    <input class='form-control mt-3' type='text' name='specialty' placeholder="Specialization" value='{{ $user->doctor->specialty ?? '' }}'>
                                                @endif
                                                <br>
